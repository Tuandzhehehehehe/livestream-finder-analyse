...
SEED_GOOD_EXAMPLES = [
    ...
    ("NON STOP TECHNO RAVE RADIO 24/7 MIX", "Electronic dance music live stream DJ set rave", 1),
    ("Live Music Concert Festival 2026", "Live DJ performance online EDM rave festival", 1),
    ("Gaming Championship Finals Live", "Esports tournament live broadcast stream", 1),
